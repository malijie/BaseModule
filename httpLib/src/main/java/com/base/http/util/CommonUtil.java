...
public class CommonUtil {
    ...
    public static int getColor(int res) {
        return BaseProfile.mContext.getResources().getColor(res);
    }

    public static Drawable getDrawable(int res) {
        return ContextCompat.getDrawable(BaseProfile.mContext, res);
    }

    public static boolean hasInternet() {
        ConnectivityManager connectivity = (ConnectivityManager) BaseProfile.mContext
    ...
    public static String getResString(int resId) {
        return BaseProfile.mContext.getResources().getString(resId);
    }

    public static View getView(int resId) {
        return LayoutInflater.from(BaseProfile.mContext).inflate(resId, null);
    }
...
//        return new SimpleDateFormat("hh").format(new Date());
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) BaseProfile.mContext.getSystemService(Context.WINDOW_SERVICE);
